...
<body>
    <div class="container">
        ...
        <div class="login-form">
            <h3 class="text-center gradient-heading mb-4">Sign Up</h3>
            <?= form_open('signup/auth') ?>
                ...
                <button type="submit" class="btn btn-gradient col-12 mb-3">Sign Up</button>
            <?= form_close() ?>
            <p class="small text-muted text-center mb-1">Already have an account? <a href="<?= base_url('login') ?>">Login</a></p>
        </div>
    </div>
